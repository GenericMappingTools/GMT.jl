...
- **B** or *axis* or *frame*
  ...
  Set map boundary frame and axes attributes. Extended at [axis](@ref)
...
- **J** or *proj* : *proj=<parameters>*
   ...
   Select map projection. Extended at [proj](@ref)
...
- **R** or *region* or *limits* : *limits=(xmin, xmax, ymin, ymax)* **|** *limits=(BB=(xmin, xmax, ymin, ymax),)*
   **|** *limits=(LLUR=(xmin, xmax, ymin, ymax),units="unit")* **|** ...more 
   ...
   Specify the region of interest. Extended at [limits](@ref)
...
- **U** or *stamp* : *stamp=true* **|** *stamp=(just="code", pos=(dx,dy), label="label", com=true)*
   ...
   Draw GMT time stamp logo on plot. Extended at [stamp](@ref)

- **V** or *verbose* : *verbose=true* **|** *verbose=level*

   Select verbosity level. Extended at [verbose](@ref)
...
- **Y** or *y_off* or *y_offset* : *y_off=[] **|** *y_off=y-shift* **|** *y_off=(shift=y-shift, mov="a|c|f|r")*
   ...
   Shift plot origin. Extended at [y_off](@ref)
