...
```julia
    ...
    basemap!(inset=(inside=true, anchor=:TR, width=3.8, offset=(0.4, 0.25),
                    save="xx000"), box=(fill=:white, pen=1, clearance=0.1,
                    shaded=true))
    ...
    basemap!(inset=(inside=true, anchor=:TR, size=(mapW, mapH),
                    offset=(0.4, 0.25),save="xx000"),
