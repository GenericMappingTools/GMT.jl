...
```julia
	...
	colorbar!(g_cpt, pos=(mirror=true, anchor=:RM, offset=(1.5,0), triangles=true, neon=true),
	          xaxis=(annot=2, label=:GEOID), yaxis=(label=:m,), Vd=1)
	...
	colorbar!(t_cpt, pos=(mirror=true, anchor=:RM, offset=(1.5,0), neon=true), shade=0.3,
