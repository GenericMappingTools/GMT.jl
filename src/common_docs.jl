...
const opt_U = "**U** : **stamp** : -- Str or Bool or [] --   '[[just]/dx/dy/][c|label]'
    Draw GMT time stamp logo on plot."

const opt_V = "**V** : **verbose** : -- Bool or Str --   '[level]'
    Select verbosity level 
    [`-V`](http://gmt.soest.hawaii.edu/doc/latest/psxy.html#v)"

const opt_X = "**X** : **x_offset** : -- Str --   '[a|c|f|r][x-shift[u]]'"

const opt_Y = "**Y** : **y_offset** : -- Str --   '[a|c|f|r][y-shift[u]]'
    Shift plot origin. 
