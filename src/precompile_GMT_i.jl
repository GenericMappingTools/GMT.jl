function _precompile_()
	...
	@assert Base.precompile(Tuple{typeof(sprintf),String,Float64,Vararg{Float64, N} where N})   # time: 0.0423703
	@assert Base.precompile(Tuple{typeof(get_marker_name),Dict{Symbol, Any},Matrix{Float64},Matrix{Symbol},Bool,Bool})   # time: 0.0417101
