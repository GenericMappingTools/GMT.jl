function _precompile_()
	...
	@assert Base.precompile(Tuple{typeof(make_color_column),Dict{Symbol, Any},String,String,Int64,Int64,Int64,Bool,Bool,Vector{String},Matrix{Float64},Nothing})   # time: 0.1258531
