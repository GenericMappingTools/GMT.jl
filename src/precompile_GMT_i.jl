function _precompile_()
	...
	@assert Base.precompile(Tuple{typeof(make_color_column),Dict{Symbol, Any},String,String,Int64,Int64,Int64,Bool,Bool,Bool,Vector{String},Matrix{Float64}})   # time: 0.1258531
