function _precompile_()
    ...
    precompile(Tuple{typeof(GMT.add_opt),Dict{Symbol,Any},String,String,Array{Any,2}})
    ...
    precompile(Tuple{typeof(convert),Type{Ptr{GMT.GMT_MATRIX}},Ptr{Nothing}})
    precompile(Tuple{typeof(plot),Array{Float64,1},Array{Float64,1}})
    precompile(Tuple{typeof(setproperty!),GMT.GMT_GRID_HEADER,Symbol,NTuple{320,UInt8}})
    precompile(Tuple{typeof(setproperty!),GMT.GMT_GRID_HEADER,Symbol,NTuple{80,UInt8}})
end
