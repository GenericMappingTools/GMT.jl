"""
	psrose(cmd0::String="", arg1=[]; fmt="", kwargs...)
...
"""
# ---------------------------------------------------------------------------------------------------
function psrose(cmd0::String="", arg1=[]; caller=[], data=[], fmt::String="",
    ...
    return finish_PS_module(d, cmd, "", arg1, arg2, [], [], [], [], output, fname_ext, opt_T, K, "psrose")
end
