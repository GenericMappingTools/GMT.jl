...
"""
# ---------------------------------------------------------------------------------------------------
function wiggle(cmd0::String="", arg1=[]; data=[], fmt::String="",
...
# ---------------------------------------------------------------------------------------------------
wiggle!(cmd0::String="", arg1=[]; data=[], fmt::String="", K=true, O=true,  first=false, kw...) =
	wiggle(cmd0, arg1; data=data, fmt=fmt, K=K, O=O,  first=first, kw...)

wiggle(arg1=[], cmd0::String=""; data=[], fmt::String="", K=false, O=false,  first=true, kw...) =
	wiggle(cmd0, arg1; data=data, fmt=fmt, K=K, O=O,  first=first, kw...)

wiggle!(arg1=[], cmd0::String=""; data=[], fmt::String="", K=true, O=true,  first=false, kw...) =
	wiggle(cmd0, arg1; data=data, fmt=fmt, K=K, O=O,  first=first, kw...)
