...
const global CTRL = CTRLstruct(zeros(13), zeros(6), [true], [false],
                               [:arrows, :bubblechart, :basemap, :band, :clip, :coast, :colorbar, :hband, :hlines, :inset, :logo, :lines, :grdvector, :plot, :plot3, :quiver, :scatter, :scatter3, :stairs, :text, :vlines, :vband], fill(nothing, 5), ["","",""], ["","", "", "   "], [""], ["",""], [false,true], [C_NULL], [Dict()])
...
export
	...
	ogr2ogr, gdalrasterize, gdalbuildvrt, readraster, setgeotransform!, setnodata!, setproj!, destroy,
