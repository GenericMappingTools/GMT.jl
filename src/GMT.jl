...
export
	...
	hlines, hlines!, lines, lines!, legend, legend!, quiver, quiver!, stairs, stairs!, stem, stem!,vlines, vlines!,
	vband, vband!, hspan, hspan!, vspan, vspan!, basemap, basemap!, blockmean, blockmedian, blockmode, clip, clip!,
