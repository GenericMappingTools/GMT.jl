...
See full GMT docs at [`grdgravmag3d`]($(GMTdoc)supplements/potential/grdgravmag3d.html)
...
function grdgravmag3d(cmd0::String, arg1, arg2, d::Dict{Symbol, Any})
	...
	(SHOW_KWARGS[]) && print_kwarg_opts([:C :density], " Density value/gridname, or density grid")
	cmd, arg = get_opt_str_or_obj(d, cmd, [:F :track], GDtype)
	(arg !== nothing) &&
		(arg1 === nothing ? arg1 = arg : (arg2 === nothing ? arg2 = arg : (arg3 === nothing ? arg3 = arg : arg4 = arg)))
	(SHOW_KWARGS[]) && print_kwarg_opts([:F :track], " Filename or GMTdataset with locations where to compute the anomaly")
