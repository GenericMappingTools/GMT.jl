	...
	@test startswith(coast(E="+GB", Vd=2), "pscoast  -M -EGB.ENG,GB.NIR,GB.SCT,GB.WLS+z")
	@test startswith(coast(E=(states="GB",), Vd=2), "pscoast  -M -EGB.ENG,GB.NIR,GB.SCT,GB.WLS+z")
	...
	FV = sphere(10, center=(0.0,0.0,-15))
	gmtwrite("lixo.stl", FV)
	gmtwrite("lixo.stl", FV, binary=false)
	rm("lixo.stl")
