@testset "GDALext" begin
	...
	@test size(imresize(rand(UInt8, 64, 64), 0.5)) == (32,32)

	wkts = ["POINT (1198054.34 648493.09)", "LINESTRING (1181866.26359 615654.422250, 1205917.120749 623979.718958, 1227192.879004 643405.411277)", "POLYGON ((1162440.571274 672081.433272, 1162440.571274 647105.543148, 1195279.241622 647105.543148, 1162440.571274 672081.433272))"];
	readgeom(wkts[1])
	readgeom(wkts)
end