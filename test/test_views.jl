...
I = GMT.GMTimage("", "", 0, [1., 10, 1, 10, 0, 1, 1, 1, 1], [1., 1], 1, NaN, "gray", String[], String[], collect(1.:11), collect(1.:11), [0.],rand(UInt16,10,10), zeros(Int32,3), 0, Array{UInt8,2}(undef,1,1), "TRBa", 0);
imshow(I,Vd=dbg2)
