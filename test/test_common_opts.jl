@testset "COMMON OPTS" begin
	...
	I = GMT.GMTimage("", "", 0, -1, [1.,4,1,4,0,255], [1., 1], 1, zero(UInt16), "", String[], String[], collect(1.:4),collect(1.:4),zeros(3),img16, vec(zeros(Int32,1,3)), 0, Array{UInt8,2}(undef,1,1), "TCBa", 0)
	GMT.mat2img(I);
